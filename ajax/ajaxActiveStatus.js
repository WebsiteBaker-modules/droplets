        ...
        $.fn.ajaxActiveStatus = function(options) {
                ...
                $(this).click(function() {
                        ...
                        switch(oElement.attr("src")){
                            case Droplet.ThemeUrl + 'img' +"/status_1_1.png": var action = "status_1_0"; break;
                            case Droplet.ThemeUrl + 'img' +"/status_1_0.png": var action = "status_1_1"; break;
                        }
...
//                                                        oElement.animate({opacity: 0.55}), 'fast';
                                                        oElement.attr("src", Droplet.ThemeUrl + 'img' +"/"+ action +".png");
